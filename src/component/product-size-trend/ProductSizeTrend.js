...
export default class ProductSizeTrend extends Component {
  constructor(props) {
    super(props);
    let me = this;
    me.boxStyle = {
  ...
  render() {
    ...
    return (
      <div>
        <span style={{fontSize:'14px',display:'block',color:'#fff',position:'absolute',top:'44px',right:'18px'}}>万亩</span>
