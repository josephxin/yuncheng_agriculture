...
import symbol from '../stock-warn/symbol.png';
...
export default class StockWarn extends Component {
  constructor(props) {
    ...
    me.parm = {
      ...
      showLegend:true,
      legendLeft:me.props.legendLeft || 150,
      legendTop:17,
      legendIcon:'rect',
      legendColor:'#fff',
      legendFontSize:14,
      ...
      splitLineWidth:1,
      yData:this.props.num || [900, 1212, 2212, 1212, 1912, 1234, 1512],
  ...
  render() {
    ...
    return (
      <div>
        <span style={{fontSize:'14px',display:'block',color:'#fff',position:'absolute',top:this.props.top||'44px',right:this.props.right||'28px'}}>%</span>
        <div style={{...me.boxStyle,width:this.props.width||'400px',height:this.props.height||'240px'}} ref={'echarts'}>
        </div>
      </div>
    )
  }
