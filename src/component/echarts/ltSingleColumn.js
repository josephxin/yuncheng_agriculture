...
class Page extends React.Component {
	constructor(props) {
		...
		this.options = {
			title: {
				text: this.props.title ? this.props.title : '2018年各区县农产品采收量分析',
			...
			tooltip: {
				...
				formatter: function(param) {
					let html = '';
					let unit = 'kg';
					html += '<div class="tooltip-box">' + param[0].name + '<br/>采收量：';
	...
	componentDidUpdate() {
		...
		options.series[0].data = state.datay;
		options.xAxis.data = state.datax;
