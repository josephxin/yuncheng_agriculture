    ...
    this.options = {
      tooltip: {
        ...
        formatter: function (d) {
          ...
          d.forEach((s, i) => {
            if (i === 0) {
              str = [s.name, '</br>', s.seriesName, ': ', s.value+'人' || '--'].join('');
      ...
      series: [
        {
          ...
          itemStyle: {
            color: {
              ...
              colorStops: [
                {
                  offset: 0, color: 'rgba(59,255,208,1)'
                },
                {
                  offset: 1, color: 'rgba(33,119,241,1)'
                }
              ],
            }
          }
        },
        {
          ...
          areaStyle: {
            color: {
              ...
              colorStops: [
                {
                  offset: 0, color: 'rgba(255,253,4,.3)'
                },
                {
                  offset: 0.7, color: 'rgba(255,253,4,0)'
                },
                {
                  offset: 1, color: 'rgba(255,253,4,0)'
                }
              ],
            }
          }
