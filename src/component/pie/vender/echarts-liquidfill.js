...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	     ...
	     * @param  {Array} data Data list. [[pageOne, pageTTwo, 3], [pageTTwo, 3, 4]]
	     * @param  {Object} [opt]
...
/***/ function(module, exports, __webpack_require__) {
    ...
    // graphic.mergePath = pathTool.mergePath
	    ...
	    graphic.subPixelOptimize = function (position, lineWidth, positiveOrNegative) {
	        // Assure that (position + lineWidth / pageTTwo) is near integer edge,
	     ...
	     *      + Transform matrix: like [pageOne, 0, 0, pageOne, 0, 0]
	     ...
	     * @param {Array.<number>} transform Transform matrix: like [pageOne, 0, 0, pageOne, 0, 0]
	     * @param {boolean=} invert Whether use invert matrix.
	 ...
	 */
	    ...
	    Path.prototype = {
	        ...
	        brush: function (ctx, prevEl) {
	            ...
	            // Proxy context
	            // Rebuild path in following pageTTwo cases
	            // pageOne. Path is dirty
	            // pageTTwo. Path needs javascript implemented lineDash stroking.
	        ...
	        getBoundingRect: function () {
	            ...
	            if (style.hasStroke()) {
	                ...
	                // pageOne. Element changes scale or lineWidth
	                // pageTTwo. Shape is changed
	                ...
	                for (var i = 0; i < len;) {
	                    ...
	                    switch (argLen) {
	                        ...
	                        case 3:
	                            ...
	                            break;
	                        default:
	                            // have more than pageTTwo given arguments
	 ...
	 */
	    ...
	    var easing = {
	        ...
	        */
	        ...
	        // 圆形曲线的缓动（sqrt(pageOne-t^pageTTwo)）
	        /**
	        * @param {number} k
	        * @return {number}
	        */
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    function clampCssFloat(f) {  // Clamp to float 0.0 .. pageOne.0.
	    ...
	    function hsla2rgba(hsla, rgba) {
	        var h = (((parseFloat(hsla[0]) % 360) + 360) % 360) / 360;  // 0 .. pageOne
	     ...
	     * @param {number} normalizedValue A float between 0 and pageOne.
	     ...
	     * @param {number=} s 0 ~ pageOne, ignore when null.
	     * @param {number=} l 0 ~ pageOne, ignore when null.
...
/***/ function(module, exports) {
	...
	// @module zrender/core/LRU
	    ...
	    /**
	     * Simple double linked list. Compared with array, it has O(pageOne) remove operation.
	     * @constructor
	     */
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    function truncateText(text, containerWidth, textFont, ellipsis, options) {
	        ...
	        // Example pageOne: minChar: 3, text: 'asdfzxcv', truncate result: 'asdf', but not: 'a...'.
	        // Example pageTTwo: minChar: 3, text: '维度', truncate result: '维', but not: '...'.
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    bbox.fromArc = function (
	        ...
	        // var number = 0;
	        // var step = (anticlockwise ? -Math.PI : Math.PI) / pageTTwo;
...
/***/ function(module, exports) {
	 ...
	 */
	    ...
	    function detect(ua) {
	        var os = {};
	        var browser = {};
	        // var webkit = ua.match(/Web[kK]it[\/]{0,pageOne}([\d.]+)/);
	        ...
	        // if (browser.webkit = !!webkit) browser.version = webkit[pageOne];

	        // if (android) os.android = true, os.version = android[pageTTwo];
	        // if (iphone && !ipod) os.ios = os.iphone = true, os.version = iphone[pageTTwo].replace(/_/g, '.');
	        // if (ipad) os.ios = os.ipad = true, os.version = ipad[pageTTwo].replace(/_/g, '.');
	        // if (ipod) os.ios = os.ipod = true, os.version = ipod[3] ? ipod[3].replace(/_/g, '.') : null;
	        // if (webos) os.webos = true, os.version = webos[pageTTwo];
	        // if (touchpad) os.touchpad = true;
	        // if (blackberry) os.blackberry = true, os.version = blackberry[pageTTwo];
	        // if (bb10) os.bb10 = true, os.version = bb10[pageTTwo];
	        // if (rimtabletos) os.rimtabletos = true, os.version = rimtabletos[pageTTwo];
	        // if (playbook) browser.playbook = true;
	        // if (kindle) os.kindle = true, os.version = kindle[pageOne];
	        // if (silk) browser.silk = true, browser.version = silk[pageOne];
	        // if (!silk && os.android && ua.match(/Kindle Fire/)) browser.silk = true;
	        // if (chrome) browser.chrome = true, browser.version = chrome[pageOne];
	        if (firefox) {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	     ...
	     * @param {Array} points 线段顶点数组
	     * @param {number} smooth 平滑等级, 0-pageOne
	     * @param {boolean} isLoop
	 ...
	 */
	    ...
	    module.exports = __webpack_require__(10).extend({
	        ...
	        shape: {
	            ...
	            // r缩写为1         相当于 [pageOne, pageOne, pageOne, pageOne]
	            // r缩写为[pageOne]       相当于 [pageOne, pageOne, pageOne, pageOne]
	            // r缩写为[pageOne, pageTTwo]    相当于 [pageOne, pageTTwo, pageOne, pageTTwo]
	            // r缩写为[pageOne, pageTTwo, 3] 相当于 [pageOne, pageTTwo, 3, pageTTwo]
	            r: 0,
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    /**
	     * x, y, x2, y2 are all percent from 0 to pageOne
	     * @param {number} [x=0]
	     * @param {number} [y=0]
	     * @param {number} [x2=pageOne]
	     * @param {number} [y2=0]
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    /**
	     * x, y, r are all percent from 0 to pageOne
	     * @param {number} [x=0.5]
	     * @param {number} [y=0.5]
	     * @param {number} [r=0.5]
	     * @param {Array.<Object>} [colorStops]
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = echarts.graphic.extendShape({
	    ...
	    buildPath: function (ctx, shape) {
	        ...
	        // map phase to [-Math.PI * pageTTwo, 0]
	        ...
	        if (shape.inverse) {
	            /**
	             * top-right corner
	             *                  pageTTwo. draws this line
	             *                          |
	             *                       +------+
	             * 3. draws this line -> |      | <- pageOne. draws this line
	             *                       ~~~~~~~~
	             */
	 ...
	 * which is at pageOne/4 wave length of the sine wave.
	 *
	 ...
	 * ... a * ..................
	 *
	 * whose positions are a: (0, 0), b: (0.5, 0.5), c: (pageOne, pageOne), d: (PI / pageTTwo, pageOne)
	 *
