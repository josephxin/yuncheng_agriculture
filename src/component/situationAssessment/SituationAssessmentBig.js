...
import BarChart from '../barChart/BarChartBig';

/**
 *wf_df_disaster_weather
 * */
class SituationAssessmentBig extends Component {
	constructor(props) {
		super(props);
		this.state = {
			legend: [],
...
export default SituationAssessmentBig;