 ...
 */
import Base3dBar3 from './Base3dBar3';
import React from 'react';
import farmerIndex from './farmerIndex.png'

class FarmerCreditIndex3 extends React.Component {
  constructor(props) {
    super();
    this.state = {
      data: []
  ...
  componentDidMount() {
    ...
    this.refs.svgContainer.appendChild(chart.domElement);
    this.refs.svgContainer.appendChild(img);
    chart.size = { width: 55, height: 80, left: 55, top: 80, right: 140, bottom: 50 };
  ...
  componentDidUpdate() {
    ...
    this.refs.svgContainer.appendChild(chart.domElement);
    this.refs.svgContainer.appendChild(img);
    chart.size = { width: 55, height: 150, left: 55, top: 80, right: 140, bottom: 50 };
...
export default FarmerCreditIndex3
