    ...
    if (me._invalidateDataFlag) {
      ...
      data.map((d, i) => {
        if (i === 0) {
          ...
          createChart('barG' + i+"_2", 0, positionScale(0), barWidth, sizeScale(d.value), diffx, diffy, bgcColor[i]);
          createLine1('barG' + i+"_2", barWidth + diffx, line2Y2, lineX1 + barWidth + diffx, 0, bgcColor[i]);
          createLine2('barG' + i+"_2", lineX1 + barWidth + diffx, line2Y2, lineX1 + barWidth + diffx, line2Y2 + lineY1, bgcColor[i]);
          createCircle('barG' + i+"_2", lineX1 + barWidth + diffx, positionScale(0) - sizeScale(d.value) + lineY1 + circleR, circleR, bgcColor[i], d, 0, 0)
        } else if (i === 1) {
          let line2Y2=positionScale(0 + data[0]['value']) - sizeScale(d.value);

          createChart('barG' + i+"_2", 0, positionScale(0 + data[0]['value']), barWidth, sizeScale(d.value), diffx, diffy, bgcColor[i]);
          createLine1('barG' + i+"_2", barWidth + diffx, line2Y2, lineX2 + barWidth + diffx, 0, bgcColor[i]);
          createLine2('barG' + i+"_2", lineX2 + barWidth + diffx, line2Y2, lineX2 + barWidth + diffx, line2Y2 - lineY2, bgcColor[i]);
          createCircle('barG' + i+"_2", lineX2 + barWidth + diffx, line2Y2 - lineY2 + circleR, circleR, bgcColor[i], d, dx, dy)
        } else if (i === 2) {
          let line2Y2=positionScale(data[0]['value'] + data[1]['value']);

          createChart('barG' + i+"_2", 0, line2Y2, barWidth, sizeScale(d.value), diffx, diffy, bgcColor[i]);
          createLine1('barG' + i+"_2", 0, line2Y2 - sizeScale(d.value) / 2, -lineX3, 0, bgcColor[i]);
          createLine2('barG' + i+"_2", -lineX3, line2Y2 - sizeScale(d.value) / 2, -lineX3, line2Y2 - sizeScale(d.value) / 2 - lineY3, bgcColor[i]);
          createCircle('barG' + i+"_2", -lineX3, line2Y2 - sizeScale(d.value) / 2 - lineY3 + circleR, circleR, bgcColor[i], d, dx, dy)
        }
      });
