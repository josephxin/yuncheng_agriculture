...
class priceTrendRiseFall2 extends Component {
  constructor(props) {
    super(props);
    let me = this;
    this.state = {
    ...
    this.option = {
      ...
      tooltip: {
        ...
        formatter: function(params) {
          ...
          itemHtml += '<p>' + unit + '该批发市场：' + params[0].value + '元</p>';
          params[1]? itemHtml += '<p>' + unit + '对比批发市场：' + params[1].value + '元</p>' : itemHtml += ""
          itemHtml += '</div>';
          return itemHtml;
        }
      },
  ...
  componentDidUpdate() {
    ...
    this.option.series[1].data = this.state.IData.seriesData2;
    //this.option.series[2].data = this.state.IData.kData;
...
export default priceTrendRiseFall2;
